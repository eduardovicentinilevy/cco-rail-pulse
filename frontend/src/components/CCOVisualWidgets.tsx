...
const SEVERITY_STYLES: Record<Severity, { color: string; border: string }> = {
  CRITICAL: { color: 'var(--uni-danger, #FF0000)', border: 'var(--uni-danger, #FF0000)' },
  WARNING: { color: 'var(--uni-orange, #FF6600)', border: 'var(--uni-orange, #FF6600)' },
  INFO: { color: 'var(--uni-text-muted, #A3A3A3)', border: 'var(--uni-border, #2E2E2E)' },
};

const STATUS_DOT_COLOR: Record<TSSItem['status'], string> = {
  NORMAL: 'var(--uni-success, #00FF66)',
  ATENÇÃO: 'var(--uni-orange, #FF6600)',
  'CRÍTICO': 'var(--uni-danger, #FF0000)',
};
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  sectionCard: {
    backgroundColor: 'var(--uni-bg-secondary, #141414)',
    border: '1px solid var(--uni-border, #2E2E2E)',
    borderRadius: '10px',
    padding: '1.25rem',
  ...
  sectionHeader: {
    ...
    alignItems: 'center',
    marginBottom: '1rem',
    borderBottom: '1px solid var(--uni-border, #2E2E2E)',
    paddingBottom: '0.75rem',
  },
  sectionTitle: { fontSize: '0.95rem', fontWeight: 700, color: 'var(--uni-text-main, #FFFFFF)', margin: 0 },
  liveBadge: {
    fontSize: '0.65rem',
    fontWeight: 700,
    color: 'var(--uni-success, #00FF66)',
  ...
  logCountBadge: {
    fontSize: '0.7rem',
    color: 'var(--uni-text-muted, #A3A3A3)',
    backgroundColor: 'var(--uni-bg-card, #1F1F1F)',
  ...
  tssSummaryValue: { color: 'var(--uni-orange, #FF6600)', fontFamily: 'monospace' },
  emptyState: { fontSize: '0.75rem', color: 'var(--uni-text-muted, #A3A3A3)', textAlign: 'center', padding: '1rem 0' },
  tssGrid: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' },
  tssCard: {
    backgroundColor: 'var(--uni-bg-primary, #0A0A0A)',
    border: '1px solid var(--uni-border, #2E2E2E)',
    borderRadius: '8px',
    padding: '1rem',
  },
  tssTopRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' },
  tssCode: { fontSize: '0.75rem', fontWeight: 800, color: 'var(--uni-orange, #FF6600)' },
  statusDot: { width: '8px', height: '8px', borderRadius: '50%' },
  tssName: { fontSize: '0.85rem', fontWeight: 600, color: 'var(--uni-text-main, #FFFFFF)', marginBottom: '0.6rem' },
  tssVoltageContainer: { display: 'flex', alignItems: 'baseline', gap: '0.3rem' },
  voltageValue: { fontSize: '1.3rem', fontWeight: 800, color: 'var(--uni-text-main, #FFFFFF)' },
  voltageUnit: { fontSize: '0.75rem', color: 'var(--uni-text-muted, #A3A3A3)', fontWeight: 600 },
  ...
  filterChipActive: {
    borderColor: 'var(--uni-orange, #FF6600)',
  ...
  alertItem: {
    ...
    justifyContent: 'space-between',
    backgroundColor: 'var(--uni-bg-primary, #0A0A0A)',
    border: '1px solid var(--uni-bg-card, #1F1F1F)',
    padding: '0.6rem 0.8rem',
    borderRadius: '6px',
    fontSize: '0.8rem',
    gap: '0.5rem',
  },
  alertTime: { color: 'var(--uni-text-muted, #A3A3A3)', fontSize: '0.75rem', fontFamily: 'monospace' },
  alertTarget: {
    backgroundColor: 'var(--uni-orange, #FF6600)',
    color: '#FFFFFF',
    fontWeight: 700,
    fontSize: '0.7rem',
  ...
  alertMsg: {
    color: 'var(--uni-text-main, #FFFFFF)',
    flex: 1,
    whiteSpace: 'nowrap',
    overflow: 'hidden',
